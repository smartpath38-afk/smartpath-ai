      ...
      <main className="pt-24 sm:pt-32 pb-16 sm:pb-28 px-4 sm:px-6">
        <div className="max-w-lg mx-auto text-center">
          ...
          <p className="text-white/50 text-base leading-relaxed mb-2">
            Your payment was successfully processed{gwLabel ? ` via ${gwLabel}` : ""}.
          </p>
          ...
          <div className="rounded-xl border border-white/[0.07] bg-white/[0.02] p-5 mb-10 text-left">
            <p className="text-white/30 text-xs leading-relaxed">
              ...
              {user
                ? "If your dashboard doesn't reflect the new plan immediately, please wait a few seconds and refresh. Payment webhooks are processed in real-time."
                : "We created an account for you with the email you provided. Check your inbox and use \"Forgot Password\" on the login page to set your password and access your dashboard."}
            </p>
          </div>
          ...
          <p className="mt-12 text-xs text-white/20">
            Questions?{" "}
            <a href="mailto:contact@smartpathavatar.online" className="text-white/35 hover:text-white/50 transition-colors">
